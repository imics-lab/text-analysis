# -*- coding: utf-8 -*-
"""
Created on Tue Nov 24 10:04:30 2020
...
for i in range(10): 
    ...
    #train
    gaussian = GaussianNB()
    scores = cross_val_score(gaussian, X_best.toarray(), y, cv=KFold(n_splits=5))
